export class DiceRoll {
    ...
    rollDiceSet(numberOfDice: number, modifier: number, multiple: number, numberOfRolls: number, target: number) {
      ...
      private rollDice(numberOfDice: number, modifier: number, multiple: number, target: number) {
        let result = 0;
